...
TEST(Memory, Fragmentation) {
    ...
    ASSERT_LT(memoryFragments, 4 * 1024 * 1024) << "\
...
TEST(Memory, Footprint) {
    ...
    ASSERT_LT(vectorFootprint, 60 * 1024 * 1024) << "\
        mbgl::Map footprint over 60MB for vector styles.";

    ASSERT_LT(rasterFootprint, 20 * 1024 * 1024) << "\
        mbgl::Map footprint over 20MB for raster styles.";
